...
const Testimonals = () => {
  return (
    <div className="pt-20 pb-16 dark:text-gray-300 text-gray-800">
      <div className="w-11/12 mx-auto flex flex-col xmd:gap-y-24 md:gap-y-16 gap-y-12 items-center">
        ...
        <div className="flex flex-col gap-y-2 items-center " data-aos="fade-down">
          ...
          <p className="text-gray-700 dark:text-gray-400 dark:transition-all duration-300 text-sm text-center">
