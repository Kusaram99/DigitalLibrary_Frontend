...
const LibraryFeature = () => {
  ...
  return (
    <div className=" py-14 xmd:py-24 w-10/12 md:w-11/12 mx-auto flex xmd:flex-row flex-col gap-y-14 items-center  xmd:justify-between dark:text-gray-300 dark:transition-all duration-300">
      {/* -------------------- left part ---------------------------- */}
      ...
      <div className="xmd:w-[50%] md:w-[70%] sm:w-[80%] xs:w-[90%] w-[95%] mx-auto xmd:mx-0  flex flex-col gap-y-5 " data-aos ="fade-left">
        ...
        <p className="md:text-[16px] text-sm dark:text-gray-400 dark:transition-all duration-300">
          ...
          {iconData.map((data, index) => (
            <div className="flex gap-x-4 items-center" key={index}>
              ...
              <div
                ...
                ${
                  index === 1 ? "bg-purple-300 dark:text-gray-950" : index === 2 ? "bg-orange-300 dark:text-gray-950" : index === 3 ? "bg-green-300 dark:text-gray-950" : "bg-yellow-300 dark:text-gray-950"
                }
                 `}
              >
                {data.icon}
