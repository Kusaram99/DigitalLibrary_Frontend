...
const Footer = () => {
  ...
  return (
    <div className="overflow-x-hidden py-12 dark:text-gray-300 text-gray-800">
      <div className="w-11/12 mx-auto flex flex-col gap-y-6 px-4 ">
        ...
        <div className="flex flex-col mmd:flex-row mmd:gap-x-10 gap-y-10 pt-4 pb-8">
          ...
          <div
            className="flex flex-col mmd:items-start items-center gap-y-4 xlg:w-[35%] mmd:w-[40%]"
            data-aos="fade-right"
          >
            {/* ----------- logo ------------------ */}
            <Link
            ...
            <p className="md:text-[16px] text-sm text-center mmd:text-left dark:text-gray-400 dark:transition-all transition-all duration-300">
          ...
          <div className="mmd:w-[60%] flex gap-y-8 xs:gap-y-0 gap-x-16 flex-wrap xs:flex-nowrap xs:gap-x-20 xlg:gap-x-36 xlg:justify-center mmd:justify-start xs:justify-center px-4  pt-6 ">
            ...
            <div className="flex flex-col gap-y-4 " data-aos="fade-down">
              <h2 className="font-semibold mmd:text-lg text-[16px]">
                Important Links
              </h2>
        ...
        <div
          className="py-8 flex flex-col gap-y-3 sm:gap-y-0 sm:flex-row justify-center items-center text-sm font-semibold"
          data-aos="fade-left"
        >
          <p className="hidden sm:flex items-center gap-x-1  ">
            {" "}
            <span>
              <CiAt />
            </span>
            ...
            {/* || Made with 
           <FaHeart className='text-heart' />Ram */}
          </p>

          <p className="flex sm:hidden gap-x-1 items-center ">
            <span>
              <CiAt />
            </span>
            Copyright 2025 , All rights reserved
          ...
          <p className="flex sm:hidden gap-x-1 items-center ">
            Made with <FaHeart className="text-heart" />
            ....{" "}
          </p>
        </div>
      </div>
